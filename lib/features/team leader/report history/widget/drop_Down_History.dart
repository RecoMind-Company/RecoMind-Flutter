...
class DropDownHistory extends StatefulWidget {
  DropDownHistory({super.key, required this.selected});
  ...
  @override
  State<DropDownHistory> createState() => _DropdownState();
}

class _DropdownState extends State<DropDownHistory> {
            ...
            children: [
              TextField(
                ...
                decoration: InputDecoration(
                  ...
                  hintText: selectedCountryValue ?? "Select",
